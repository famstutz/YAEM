// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IServiceCallbackTest.cs" company="Florian Amstutz">
//   Copyright (c) Florian Amstutz. All rights reserved.
// </copyright>
// <summary>
//   This is a test class for IServiceCallbackTest and is intended to contain all IServiceCallbackTest Unit Tests.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace YAEM.Contracts.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class IServiceCallbackTest
    {
        /// <summary>
        ...
        {
            var mock = new Mock<IServiceCallback>();

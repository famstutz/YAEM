// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IUserServiceCallbackTest.cs" company="Florian Amstutz">
//   Copyright (c) Florian Amstutz. All rights reserved.
// </copyright>
// <summary>
//   This is a test class for IUserServiceCallbackTest and is intended to contain all IUserServiceCallbackTest Unit Tests.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace YAEM.DesktopClient.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class IUserServiceCallbackTest
    {
        /// <summary>
        ...
        {
            var mock = new Mock<IUserServiceCallback>();
